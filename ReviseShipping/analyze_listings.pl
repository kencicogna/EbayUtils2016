...
################################################################################
my %opts;
getopts('ai:rDm:w:P',\%opts);

# Primary Options:
# -a    => All items processing
# -i    => Item id (ebayItemId) of single item to process
# -r    => Revise item(s) on ebay
# -P    => Production DB connection       # NOTE: This should be use most of the time, unless you 
...
my $weight_in;                  # TODO: Simplify by getting rid of this option?
